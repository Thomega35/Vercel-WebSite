...
const SideBar = () => {
    const [open, setOpen] = useState(localStorage.getItem('open') === 'true' ? true : false);
    const [subMenuOpen, setSubMenuOpen] = useState(localStorage.getItem('subMenuOpen') === 'true' ? true : false);
